package id.co.tripoin.util.ui.geo.shared;

/**
 * @author <a href="mailto:ridla.fadilah@gmail.com">Ridla Fadilah</a>
 */
import id.co.tripoin.util.ui.geo.Geolocator;
                ...
                Geolocation.getIfSupported().getCurrentPosition(
                        new Callback<Position, PositionError>() {
                            ...
                            public void onSuccess(Position r) {
                                id.co.tripoin.util.ui.geo.shared.Position position = new id.co.tripoin.util.ui.geo.shared.Position();
