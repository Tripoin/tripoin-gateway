 ...
 */
@Service
public class ScaffoldingResponseConstructorImpl<DATA> implements IScaffoldingResponseConstructor<DATA> {

    private static Logger LOGGER = LoggerFactory.getLogger(ScaffoldingResponseConstructorImpl.class);
