...
public final class InfoMarkerConstant {
	...
	public static final String DEB_LOCALE_CHANGED = "locale changed, updating locale resolver";
	...
	public static final String ERR_WEB_SERVICE_USERNAME_PASSWORD = "Username or Password not null!";
	public static final String DEB_AUTH_PROVIDER = "User [{}] successfully logged in web service";
