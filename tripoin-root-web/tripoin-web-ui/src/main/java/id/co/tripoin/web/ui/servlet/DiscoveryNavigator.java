...
public class DiscoveryNavigator extends Navigator implements ViewCacheContainer {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7342442744694683496L;

	protected class ViewCache implements Serializable {
		/**
		 * 
		 */
		private static final long serialVersionUID = 2404062567294954911L;
	...
	protected void initViews() {
		if (views.isEmpty() || views == null) {
			...
			for (String beanName : beansName) {
				...
				// Check for a valid bean class because "abstract" beans may not
				// have a bean class defined.
